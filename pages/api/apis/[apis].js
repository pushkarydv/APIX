export default function handler(req, res) {
  ...
  switch (apis) {
    ...
    case "calendar":
      ...
      break;
    case "cloudstorageandfilesharing":
      res.status(200).json({
        data: [
          [
            "AnonFiles",
      ...
      res.status(200).json({
        data: [
          ...
          [
            ...
            " Green Power Index for Germany (Grfcnstromindex/GSI",
            " No ",
            " No ",
            " Yes ",
          ],
      ...
      res.status(200).json({
        data: [
          ...
          [
            ...
            " Multi languages Poke9mon TCG Information ",
            " No ",
            " Yes ",
            " Yes ",
          ],
      ...
      res.status(200).json({
        data: [
          ...
          [
            ...
            " Open data of the city Umee5 in northen Sweden ",
            " No ",
            " Yes ",
            " Yes ",
          ],
      ...
      res.status(200).json({
        data: [
          ...
          [
            ...
            " Team radio and interview quotes by Finnish F1 legend Kimi Re4ikkf6nen ",
            " No ",
            " Yes ",
            " Yes ",
          ],
      ...
      res.status(200).json({
        data: [
          ...
          [
            ...
            " Bordeaux Me9tropole public transport and more (France",
            " `apiKey` ",
            " Yes ",
            " Unknown ",
          ],
      ...
      res.status(200).json({
        data: [
          [
            ...
            " Vehicles information from Fundae7e3o Instituto de Pesquisas Econf4micas - Fipe ",
            " No ",
            " Yes ",
            " No ",
          ],
    ...
    case "weather":
      ...
      break;
    default:
      res.status(404).json({ error: `${apis} does not exist` });
  }
}
